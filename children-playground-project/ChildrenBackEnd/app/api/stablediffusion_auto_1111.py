...
class StableDiffusionAuto1111:
    def __init__(self):
        self._endPoint = "https://69eac0c56b99dd280e.gradio.live"
        self._payload = {
            "restore_faces": True,
            "prompt": None,
    ...
    def get_image(self, image_model_id, prompt = None, negative_prompt = None):
        ...
        path = f'../src/images/{random_number}.png'
        return path
    ...
    def test_image(self):
        ...
        self._payload = {
            "restore_faces": True,
            "prompt": "<lora:brighter-eye1:1>, snowman, smile, masterpiece, best quality, high quality",
