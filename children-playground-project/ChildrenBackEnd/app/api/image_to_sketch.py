...
class ImageToSketch:
    ...
    def image_to_sketch(self, image_name):
        # 여기서 이미지를 컨버트 할 수 있도록 api를 만들자.
        # 현재 작업 디렉토리를 변경합니다.
        os.chdir("/Users/itstime/children-playground/children-playground-project/ChildrenBackEnd/app/api")

        # image = cv2.imread(f'{image_name}.png')
        image = cv2.imread('8756.png')  # loads an image from the specified file
