...
export const gausian1 = document.getElementById("g1");
export const gausian2 = document.getElementById("g2");
export const gausian3 = document.getElementById("g3");
export const gausian4 = document.getElementById("g4");
